...
// Variable to store the /assets/slider we need to set as background
var photos = [ 
...
jQuery(document).ready(function($) { 
	...
	$("#control").toggle(function(){
		...
		$(this).css({ "background-image" : "url(/assets/slider/btn_pause.png)" });
	...
	var stopAnimation = function() {
		...
		$("#control").css({ "background-image" : "url(/assets/slider/btn_play.png)" });
